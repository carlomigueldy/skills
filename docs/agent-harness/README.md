# Plugin Operations Harness

This stack-agnostic harness guides compatible coding agents through plugin maintenance, creation, refinement, testing, and red-team review. It governs this repository and is not an installable plugin.

- [Role cards](roles.md) define Sol, Terra, Luna, ownership, and delegation.
